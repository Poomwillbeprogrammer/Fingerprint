...
router.post('/login', loginLimiter, async (req, res) => {
  ...
  try {
    ...
    const instructorName = admin.instructor_name || '';
    const assignedSubjects = Array.isArray(admin.assigned_subjects) ? admin.assigned_subjects : [];
...
router.get('/me', authRequired, (req, res) => {
  res.json({
    ...
    instructor_name: req.admin.instructor_name || '',
    assigned_subjects: Array.isArray(req.admin.assigned_subjects) ? req.admin.assigned_subjects : []
  });
});
