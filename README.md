...
* **🎯 Accurate 3-Tier Hardware Health Monitoring & Fail-Fast Guard (ADR-027):**
  * แยกสถานะการเชื่อมต่อระหว่าง **Cloud Bridge**, **เซนเซอร์ลายนิ้วมือ R307**, และ **หน้าจอ OLED (SH1106)** ออกจากกันอย่างอิสระ
  * แถบ Sidebar แสดงการ์ดสถานะ 3 บรรทัดชัดเจน:
    ...
    - 🖥️ **จอ OLED:** `พร้อมใช้งาน` (เขียว) / `ไม่มีจอ / ปิด` (เทากลาง)
